...
export default async function ConferenciaPrecosPage({
  ...
  return (
    <div>
      <CabecalhoPagina
        titulo="Conferência de Preços"
        descricao={`Compare o preço praticado em cada abastecimento com o acordo/negociação vigente${souPosto ? " com o cliente" : " com o posto"}, e acompanhe o extrato diário por meio de pagamento${nomeEmpresaSelecionada ? ` — ${nomeEmpresaSelecionada}` : ""}.`}
      />
