...
const GraficoVariacaoPrecos = dynamic(
  () => import("./GraficoVariacaoPrecos").then((m) => m.GraficoVariacaoPrecos),
  {
    ssr: false,
    loading: () => (
      <div className="flex h-[240px] items-center justify-center rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 text-sm text-slate-400">
        Carregando gráfico...
      </div>
    ),
  }
