  ...
  return (
    <div className="mt-8">
      <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100">🎯 Missões de engajamento</h2>
...
function MissaoForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="card mb-4 space-y-4 p-4">
      ...
      <label className="flex items-start gap-2 rounded-lg bg-slate-50 dark:bg-slate-800/50 p-3 text-sm text-slate-700 dark:text-slate-300">
        <input
          type="checkbox"
