...
export function FormularioFiscal({ empresaId, dados }: { empresaId: string; dados: DadosAtuais }) {
  ...
  return (
    <div className="card p-6">
      <h2 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Dados fiscais do emitente</h2>
      ...
      >
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Inscrição Estadual</label>
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">RNTRC (registro ANTT)</label>
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Série do CT-e</label>
          <input type="number" name="serie_cte" min={1} step={1} defaultValue={dados?.serie_cte ?? 1} className="input w-full text-sm" />
        </div>
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Série do MDF-e</label>
          <input type="number" name="serie_mdfe" min={1} step={1} defaultValue={dados?.serie_mdfe ?? 1} className="input w-full text-sm" />
        </div>
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Ambiente</label>
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Provedor fiscal</label>
