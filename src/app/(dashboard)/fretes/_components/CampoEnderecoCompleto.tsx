    ...
    <div className="rounded-lg border border-slate-200 dark:border-slate-700 p-4">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-6">
        <div className="sm:col-span-4">
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Rua / Av.</label>
          <input type="text" name={`${prefixo}_rua`} defaultValue={valorInicial?.rua ?? ""} className="input" />
        </div>
        <div className="sm:col-span-2">
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Número</label>
          <input type="text" name={`${prefixo}_numero`} defaultValue={valorInicial?.numero ?? ""} className="input" />
        </div>
        <div className="sm:col-span-2">
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Bairro</label>
          <input type="text" name={`${prefixo}_bairro`} defaultValue={valorInicial?.bairro ?? ""} className="input" />
        </div>
        <div className="sm:col-span-2">
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Cidade</label>
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">CEP</label>
          <input type="text" name={`${prefixo}_cep`} defaultValue={valorInicial?.cep ?? ""} className="input" />
        </div>
        <div className="sm:col-span-6">
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Ponto de referência (opcional)</label>
        ...
        <div className="sm:col-span-2">
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Hora</label>
          <input type="time" name={`${prefixo}_hora`} defaultValue={valorInicial?.hora ?? ""} className="input" />
        </div>
        <div className="sm:col-span-3">
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Contato no local (nome)</label>
          <input type="text" name={`${prefixo}_contato_nome`} defaultValue={valorInicial?.contatoNome ?? ""} className="input" />
        </div>
        <div className="sm:col-span-3">
          <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Telefone do contato</label>
