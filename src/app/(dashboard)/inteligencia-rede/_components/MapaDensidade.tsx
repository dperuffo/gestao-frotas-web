...
export function MapaDensidade({ pontos }: { pontos: PontoDensidade[] }) {
  ...
  if (pontos.length === 0) {
    return (
      <div className="flex h-[680px] items-center justify-center rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 text-sm text-slate-400">
  ...
  return (
    <div className="relative h-[680px] overflow-hidden rounded-lg border border-slate-200 dark:border-slate-700">
