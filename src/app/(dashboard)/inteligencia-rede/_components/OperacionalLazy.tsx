...
import type { Operacional as OperacionalType } from "./Operacional";
...
const Operacional = dynamic(() => import("./Operacional").then((m) => m.Operacional), {
  ssr: false,
  loading: () => (
...
export default function OperacionalLazy(props: ComponentProps<typeof OperacionalType>) {
  return <Operacional {...props} />;
}
