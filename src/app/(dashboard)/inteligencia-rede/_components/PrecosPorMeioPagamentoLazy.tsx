...
import type { PrecosPorMeioPagamento as PrecosPorMeioPagamentoType } from "./PrecosPorMeioPagamento";
...
const PrecosPorMeioPagamento = dynamic(() => import("./PrecosPorMeioPagamento").then((m) => m.PrecosPorMeioPagamento), {
  ssr: false,
  loading: () => (
...
export default function PrecosPorMeioPagamentoLazy(props: ComponentProps<typeof PrecosPorMeioPagamentoType>) {
  return <PrecosPorMeioPagamento {...props} />;
}
