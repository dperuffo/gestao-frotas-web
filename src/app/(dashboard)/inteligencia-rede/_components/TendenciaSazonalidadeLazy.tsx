...
import type { TendenciaSazonalidade as TendenciaSazonalidadeType } from "./TendenciaSazonalidade";
...
const TendenciaSazonalidade = dynamic(() => import("./TendenciaSazonalidade").then((m) => m.TendenciaSazonalidade), {
  ssr: false,
  loading: () => (
...
export default function TendenciaSazonalidadeLazy(props: ComponentProps<typeof TendenciaSazonalidadeType>) {
  return <TendenciaSazonalidade {...props} />;
}
