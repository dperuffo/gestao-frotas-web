...
import type { ScorePerformance as ScorePerformanceType } from "./ScorePerformance";
...
const ScorePerformance = dynamic(() => import("./ScorePerformance").then((m) => m.ScorePerformance), {
  ssr: false,
  loading: () => (
...
export default function ScorePerformanceLazy(props: ComponentProps<typeof ScorePerformanceType>) {
  return <ScorePerformance {...props} />;
}
