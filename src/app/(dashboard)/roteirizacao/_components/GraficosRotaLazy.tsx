...
const GraficosRota = dynamic(() => import("./GraficosRota").then((m) => m.GraficosRota), {
  ssr: false,
  loading: () => (
    <div className="flex h-[700px] items-center justify-center rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 text-sm text-slate-400">
      Carregando gráficos...
    </div>
  ),
});
