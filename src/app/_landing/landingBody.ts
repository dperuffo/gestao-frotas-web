...
var _i18n = {
  pt: {
    ...
    card6_t: "Missões e Fidelidade",
    card6_d: "Crie metas com prêmios pros motoristas parceiros, dentro da sua rede ou em conjunto com outras empresas do mesmo grupo econômico.",
    card7_t: "Parcerias Locais",
    card7_d: "Conecte sua rede a comércios locais — borracharia, oficina, restaurante — com benefícios exclusivos pros motoristas.",
    card8_t: "Antifraude",
    card8_d: "Regras automáticas sinalizam abastecimentos e rotas fora do padrão antes que virem prejuízo.",
    // Marketplace de Fretes (Task 13)
    fretes_lbl: "Marketplace de Fretes",
    fretes_title: "Conecte cargas e motoristas,<br>com segurança pros dois lados",
    fretes_sub: "Cliente publica o frete com endereço completo e prazo; motorista decide com dados reais antes de aceitar. Negociação, execução e avaliação — tudo dentro da mesma plataforma, sem intermediário.",
    frcard0_t: "Frete com dados completos",
    frcard0_d: "Endereço estruturado de coleta e entrega, dimensões da carga, datas e horários — o motorista decide com informação real antes de aceitar.",
    frcard1_t: "Reputação do motorista",
    frcard1_d: "Nota, taxa de conclusão, CNH válida, telefone e autenticação em duas etapas verificados — o cliente vê tudo antes de negociar.",
    frcard2_t: "Calculadora de lucro",
    frcard2_d: "O motorista simula o custo de combustível da viagem com o preço médio ANP da região antes de decidir se vale a pena aceitar.",
    frcard3_t: "Filtro por veículo e carroceria",
    frcard3_d: "Motorista vê só os fretes compatíveis com o veículo que tem; cliente restringe o frete pro tipo de carroceria certo.",
    frcard4_t: "Distância até a coleta",
    frcard4_d: "Antes de aceitar, o motorista vê quantos km faltam até o ponto de coleta — geolocalização em tempo real, sem letra miúda.",
    frcard5_t: "Destaques automáticos",
    frcard5_d: "Motoristas com elogios recorrentes — pontual, cuidado com a carga, comunicativo — ganham selos automáticos no perfil.",
    fretes_cta: "🚚 Publicar meu primeiro frete →",
    ...
    // Acesse de Onde Estiver (PWA)
    acesso_lbl: "Acesse de Onde Estiver",
    acesso_title: "Web ou celular — você escolhe",
    acesso_sub: "Gestão de frotas na palma da mão: acompanhe tudo pelo computador ou instale o app no celular pra ter agilidade de onde estiver.",
    accard0_t: "Painel Web Completo",
    accard0_d: "Todos os recursos, ideal pra planejamento e análises no computador.",
    accard0_cta: "Acessar plataforma →",
    accard1_t: "App do Cliente e Posto",
    accard1_d: "Abastecimentos, negociações e indicadores direto do celular — instale como um app nativo.",
    accard1_cta: "Abrir app →",
    accard2_t: "App do Motorista",
    accard2_d: "\"Estrada que Cuida\" — abastecimentos, fretes, missões e benefícios pro motorista, no bolso.",
    accard2_cta: "Abrir app →",
    acesso_ios_t: "🍏 No iPhone (Safari)",
    acesso_ios_d: "1. Abra o link no <strong>Safari</strong>.<br>2. Toque no ícone de Compartilhar (⬆️).<br>3. Toque em \"Adicionar à Tela de Início\".<br>4. Confirme em \"Adicionar\".",
    acesso_android_t: "🤖 No Android (Chrome)",
    acesso_android_d: "1. Abra o link no <strong>Chrome</strong>.<br>2. Toque no menu (⋮).<br>3. Toque em \"Instalar aplicativo\" ou \"Adicionar à tela inicial\".<br>4. Confirme — pronto.",
    // Steps PT
  ...
  en: {
    ...
    card6_t: "Missions & Loyalty",
    card6_d: "Create goals with rewards for partner drivers, within your own network or jointly with other companies in the same economic group.",
    card7_t: "Local Partnerships",
    card7_d: "Connect your network to local businesses — tire shops, repair shops, restaurants — with exclusive perks for drivers.",
    card8_t: "Fraud Prevention",
    card8_d: "Automatic rules flag fueling and routes outside the normal pattern before they become a loss.",
    // Freight Marketplace (Task 13)
    fretes_lbl: "Freight Marketplace",
    fretes_title: "Connect cargo and drivers,<br>safely for both sides",
    fretes_sub: "Shippers post the freight with a full address and deadline; drivers decide with real data before accepting. Negotiation, execution and rating — all inside the same platform, no middleman.",
    frcard0_t: "Freight with complete data",
    frcard0_d: "Structured pickup and delivery address, cargo dimensions, dates and times — drivers decide with real information before accepting.",
    frcard1_t: "Driver reputation",
    frcard1_d: "Rating, completion rate, valid license, verified phone and two-factor authentication — shippers see it all before negotiating.",
    frcard2_t: "Profit calculator",
    frcard2_d: "Drivers simulate the trip's fuel cost using the regional average ANP price before deciding if it's worth accepting.",
    frcard3_t: "Vehicle and body type filter",
    frcard3_d: "Drivers only see freights compatible with the vehicle they have; shippers restrict the freight to the right body type.",
    frcard4_t: "Distance to pickup",
    frcard4_d: "Before accepting, the driver sees how many km remain to the pickup point — real-time geolocation, no fine print.",
    frcard5_t: "Automatic badges",
    frcard5_d: "Drivers with recurring praise — punctual, careful with cargo, communicative — automatically earn badges on their profile.",
    fretes_cta: "🚚 Post my first freight →",
    ...
    // Access from anywhere (PWA)
    acesso_lbl: "Access From Anywhere",
    acesso_title: "Web or mobile — you choose",
    acesso_sub: "Fleet management in the palm of your hand: keep track from your computer or install the app on your phone for agility wherever you are.",
    accard0_t: "Full Web Dashboard",
    accard0_d: "All features, ideal for planning and analysis on your computer.",
    accard0_cta: "Access platform →",
    accard1_t: "Client & Gas Station App",
    accard1_d: "Fuel-ups, negotiations and indicators right on your phone — install it like a native app.",
    accard1_cta: "Open app →",
    accard2_t: "Driver App",
    accard2_d: "\"Estrada que Cuida\" — fuel-ups, freight jobs, missions and driver perks, in your pocket.",
    accard2_cta: "Open app →",
    acesso_ios_t: "🍏 On iPhone (Safari)",
    acesso_ios_d: "1. Open the link in <strong>Safari</strong>.<br>2. Tap the Share icon (⬆️).<br>3. Tap \"Add to Home Screen\".<br>4. Confirm by tapping \"Add\".",
    acesso_android_t: "🤖 On Android (Chrome)",
    acesso_android_d: "1. Open the link in <strong>Chrome</strong>.<br>2. Tap the menu (⋮).<br>3. Tap \"Install app\" or \"Add to Home screen\".<br>4. Confirm — done.",
