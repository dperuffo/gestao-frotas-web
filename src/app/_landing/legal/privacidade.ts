...
<h2>4. Subprocessadores</h2><ul><li><strong>Stripe:</strong> Pagamentos (PCI DSS Level 1)</li><li><strong>Supabase:</strong> Banco de dados</li><li><strong>Resend:</strong> E-mails transacionais</li><li><strong>Cloudflare:</strong> CDN e WAF</li><li><strong>Upstash:</strong> Cache Redis</li><li><strong>MouseFlow:</strong> Mapa de calor e gravação de sessão, para análise de usabilidade</li></ul>
