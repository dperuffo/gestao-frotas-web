...
export const ESTILO = `
:root{--navy:#04112e;--blue:#0d2d6b;--cyan:#00b4d8;--white:#ffffff;--gray:#8a9bb5;--text:#c8d6e8;}
...
.doc-tag{display:inline-block;background:rgba(0,180,216,0.1);border:1px solid rgba(0,180,216,0.25);color:var(--cyan);font-size:0.72rem;font-weight:600;padding:4px 14px;border-radius:100px;letter-spacing:0.12em;text-transform:uppercase;margin-bottom:16px;}
h1{font-family:'Outfit',sans-serif;font-size:2.4rem;font-weight:800;color:var(--white);letter-spacing:-0.02em;margin-bottom:12px;line-height:1.2;}
.doc-meta{font-size:0.82rem;color:var(--gray);}
h2{font-family:'Outfit',sans-serif;font-size:1.15rem;font-weight:700;color:var(--white);margin:40px 0 14px;padding-left:14px;border-left:3px solid var(--cyan);}
...
.highlight{background:rgba(0,180,216,0.07);border:1px solid rgba(0,180,216,0.15);border-radius:10px;padding:20px 24px;margin:24px 0;font-size:0.9rem;}
...
<h2>2. Dados Coletados</h2><ul><li>Cadastro: nome, e-mail (via Google OAuth), CNPJ da empresa</li><li>Operacionais: abastecimentos, frota, acordos de preços</li><li>Uso: logs de acesso, dados de sessão</li><li>Pagamento: processado exclusivamente pelo Stripe (PCI DSS) — não armazenamos dados de cartão</li></ul>
...
<h2>4. Subprocessadores</h2><ul><li><strong>Stripe:</strong> Pagamentos (PCI DSS Level 1)</li><li><strong>Supabase:</strong> Banco de dados</li><li><strong>Resend:</strong> E-mails transacionais</li><li><strong>Cloudflare:</strong> CDN e WAF</li><li><strong>Upstash:</strong> Cache Redis</li></ul>
