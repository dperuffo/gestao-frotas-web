...
body{font-family:'Inter',sans-serif;background:#26303d;color:#fff;min-height:100vh}
...
.logo{font-size:1.2rem;font-weight:700;color:#fff}.logo span{color:#87ceeb}
...
h1{font-size:2.2rem;font-weight:700;margin-bottom:16px;background:linear-gradient(135deg,#fff,#87ceeb);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
h2{font-size:1.3rem;font-weight:600;color:#87ceeb;margin:40px 0 12px}
...
.badge{display:inline-block;background:rgba(135,206,235,0.15);border:1px solid rgba(135,206,235,0.3);border-radius:20px;padding:4px 14px;font-size:.8rem;color:#87ceeb;margin:4px}
...
<div class="hero">
  ...
  <h2>Contato</h2>
  <div class="card">
    <p>&#128231; <strong>E-mail:</strong> <a href="mailto:contato@fxgestaodefrotasonline.com" style="color:#87ceeb">contato@fxgestaodefrotasonline.com</a></p>
    <p>&#127760; <strong>Plataforma:</strong> <a href="https://fxgestaodefrotasonline.com" style="color:#87ceeb">fxgestaodefrotasonline.com</a></p>
