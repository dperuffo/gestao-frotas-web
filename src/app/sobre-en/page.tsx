...
import { TITULO, ESTILO, CORPO } from "@/app/_landing/legal/sobre-en";
...
// "/sobre" se o visitante já tiver escolhido o outro idioma antes
    ...
    <>
      ...
      <script
        dangerouslySetInnerHTML={{
          __html: `(function(){var l=localStorage.getItem("fni_lang")||"pt";if(l!=="en"){window.location.replace("/sobre");}})();`,
        }}
      />
