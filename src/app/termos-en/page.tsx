...
import { TITULO, ESTILO, CORPO } from "@/app/_landing/legal/termos-en";
...
// "/termos" se o visitante já tiver escolhido o outro idioma antes
...
export default function Pagina() {
  return (
    <>
      ...
      <link
        href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;600;700;800&family=Inter:wght@300;400;500&display=swap"
        rel="stylesheet"
      />
      <style dangerouslySetInnerHTML={{ __html: ESTILO }} />
      <script
        dangerouslySetInnerHTML={{
          __html: `(function(){var l=localStorage.getItem("fni_lang")||"pt";if(l!=="en"){window.location.replace("/termos");}})();`,
        }}
      />
