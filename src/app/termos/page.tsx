...
import { TITULO, ESTILO, CORPO } from "@/app/_landing/legal/termos";
...
// "/termos-en" se o visitante já tiver escolhido o outro idioma antes
    ...
    <>
      ...
      <script
        dangerouslySetInnerHTML={{
          __html: `(function(){var l=localStorage.getItem("fni_lang")||"pt";if(l!=="pt"){window.location.replace("/termos-en");}})();`,
        }}
      />
